...
const int32_t Throttledisable91::ID = 0x91;

// public
Throttledisable91::Throttledisable91() { Reset(); }

void Throttledisable91::UpdateData(uint8_t* data) {
  set_p_throttle_disable_magic(data);
}

void Throttledisable91::Reset() { }
...
void Throttledisable91::set_p_throttle_disable_magic(uint8_t* data) {
  Byte to_set0(data + 0);
